...
export default {
  ...
  // Very badly defined function, with troubles
  activate(state) {
  ...
  // To retrieve the cleaned data from google and github this
  // method uses a clear and well structured aproach
  fetch() {
    let editor
    let self = this
  ...
  // A promise helps to handle the result of a http request properly
  ...
  // Get the right div form the whole html file
  scrape(html) {
    $ = cheerio.load(html)
